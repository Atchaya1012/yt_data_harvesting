...
#API key connection
def Api_connect():
    Api_Id="AIzaSyBxjZ1KvihHUripXnQL8A1LSlzq8gZioSw"
...
#MongoDB Connection
client=pymongo.MongoClient("mongodb+srv://atchualagiri:Ammu1012@cluster0.pfrfs66.mongodb.net/?retryWrites=true&w=majority")
